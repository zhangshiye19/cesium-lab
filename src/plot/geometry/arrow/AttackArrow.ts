...
function getArrowHeadPoints(points: Point[], tailLeft?: Point, tailRight?: Point) {
...
function getArrowBodyPoints(points: Point[], neckLeft: Point, neckRight: Point, tailWidthFactor: number): Array<Point> {
