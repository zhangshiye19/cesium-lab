...
export function getRectanglePositionsByCenter(options) {
  var center = options.center;
  var width = options.width;
  var height = options.height;
  var rotation = Cesium.defaultValue(options.rotation, 0);
  var originX = Cesium.defaultValue(options.originX, 0.5);
  var originY = Cesium.defaultValue(options.originY, 0.5);

  var scratchEnuMatrix = new Cesium.Matrix4();
  var scratchRotationQuat = new Cesium.Quaternion();
  var scratchSrtMatrix = new Cesium.Matrix4();
  ...
  var rotationQuat = Cesium.Quaternion.fromAxisAngle(
    Cesium.Cartesian3.UNIT_Z,
    rotation,
    scratchRotationQuat
  );
  var cmftqrs = Cesium.Matrix4.fromTranslationQuaternionRotationScale;
  var srtMatrix = cmftqrs(
    Cesium.Cartesian3.ZERO,
    rotationQuat,
    Cesium.Cartesian3.fromElements(width, height),
    scratchSrtMatrix
  );
